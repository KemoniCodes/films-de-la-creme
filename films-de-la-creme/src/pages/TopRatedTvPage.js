...
class TopRatedTvPage extends React.Component {
    state = {
        loading: true,
        movie: [],
        movie1: [],
    ...
    async componentDidMount() {
        let url = "https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=1";
        let response = await fetch(url);
        let data = await response.json();
        this.setState({ movie: data.results, loading: false })

        let url1 = 'https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=2'
        let response1 = await fetch(url1);
        let data1 = await response1.json();
        this.setState({ movie1: data1.results, loading: false })

        let url2 = 'https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=3'
        let response2 = await fetch(url2);
        let data2 = await response2.json();
        this.setState({ movie2: data2.results })

        let url3 = 'https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=4'
        let response3 = await fetch(url3);
        let data3 = await response3.json();
        this.setState({ movie3: data3.results })

        let url4 = 'https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=5'
        let response4 = await fetch(url4);
        let data4 = await response4.json();
        this.setState({ movie3: data4.results })

        let url5 = 'https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=6'
        let response5 = await fetch(url5);
        let data5 = await response5.json();
        this.setState({ movie5: data5.results })

        let url6 = 'https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=7'
        let response6 = await fetch(url6);
        let data6 = await response6.json();
        this.setState({ movie6: data6.results })

        let url7 = 'https://api.themoviedb.org/3/tv/top_rated?api_key=57a856481fc55fc8549e5927b0aaa154&language=en-US&page=8'
